	<div class="row">
	    <div class="col-lg-12">
	        ...
	        <tbody>
	           	...
	           	<?php
						 $mySQL = new MySQL();
						 $rs = $mySQL->getRows("select  id, imagem, nome, posicao, descricao, dtcadastro, dtmodificacao from tb_marca");
						 ...
						 foreach ($rs as $item ){
						 	...
						 	echo '<tr>';
								foreach ($item as $key=>$value){
									...
									if($key == "imagem"){
										echo "<td> <img src='".HTTP_THUMB.$value."' alt='LOGO'/></td>";
									}else
									echo "<td> $value </td>";
								}
								echo '<td>
						            	...
						            	<td>
						            		<a href="'.CONTEXTO.'/app/controller/marca/marcaController.php?cmd='.sha1('delete').'&id='.sha1($id).'" title="Excluir"><i class="fa fa-trash-o"></i></a>
						            	</td>';
