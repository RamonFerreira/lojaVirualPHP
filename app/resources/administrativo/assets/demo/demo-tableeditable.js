...
var editor;
    ...
    editor = new $.fn.dataTable.Editor({
        alert('dasdas');
        "ajaxUrl":"http://127.0.0.1/T&C/admin/app/resources/administrativo/assets/demo/source.json",
        "domTable":"#crudtable",
        "fields":[
            {
                "label":"Browser:",
    ...
    $('#crudtable').dataTable({
        ...
        "sAjaxSource":"http://127.0.0.1/T&C/admin/app/resources/administrativo/assets/demo/source.json",
        "bServerSide": false,
        "bAutoWidth": false,
        "bDestroy": true,
        "aoColumns":[
